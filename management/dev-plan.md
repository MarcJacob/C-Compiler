...
- Logging system displaying the full symbol tree: global scope, struct/union members, and function scopes recursively (parameters, locals, nested sub-scopes with clear boundaries, and any locally-declared struct/union/enum). [DONE]
