...
enum COMPILER_ERROR_CODE
{
	...
	COMPILER_TOKENIZER_STAGE_ERROR, // Error during the Tokenizer stage.
	COMPILER_PARSER_STAGE_ERROR, // Error during the Parser stage.
	COMPILER_INTEGRATOR_STAGE_ERROR, // Error during the Integrator stage.
};
