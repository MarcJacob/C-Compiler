	...
	union
	{
		...
		{	
			...
			struct
			{
				...
				struct Vector ArraySizes; // Vector type = Expression*. Contains expressions to be resolved to the sizes of the dimensions of the array, if any. If empty this variable isn't an array.
			} Var;
